...
// Contract configuration - Updated with actual TIPN addresses
export const TIPN_CONFIG = {
  // Main TIPN token contract
  contractAddress: '0x5ba8d32579a4497c12d327289a103c3ad5b64eb1' as const,
  // TIPN staking contract 
  stakingAddress: '0x715e56a9a4678c21f23513de9d637968d495074a' as const,
  decimals: 18,
}

// Actual TIPN staking contract ABI
export const TIPN_STAKING_ABI = [
